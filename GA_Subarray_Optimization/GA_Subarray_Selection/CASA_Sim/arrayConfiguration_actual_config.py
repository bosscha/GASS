...
PAD_CFG_FILE = 'GA_Subarray_Selection/CASA_Sim/Pads.cfg'
...
class report:
    ...
    def run(self):
        ...
        #cmd = "casa  --nogui -c GA_Subarray_Selection/CASA_Sim/arrayConfigurationSim.py -i %s"%(simParamFile)
        #cmdalt = "casapy  --nogui -c GA_Subarray_Selection/CASA_Sim/arrayConfigurationSim.py -i %s"%(simParamFile)
        
        ## change the casa executable if needed
        #if optarr.casaExec != "casa":
        #    cmd = "%s  --nogui -c GA_Subarray_Selection/CASA_Sim/arrayConfigurationSim.py -i %s"%(optarr.casaExec, simParamFile)
...
class aosConfiguration:
    ...
    def __init__(self):
        ...
        self.aosFile = "GA_Subarray_Selection/Cfg_Input_Files/aos-%s"%(strftime("%Y%m%d-%Hh%Mm%Ss", gmtime()))
...
if __name__ == "__main__":
    ...
    a.run()
    file_name=a.run()
    file_0="Actual_Config.txt"
    with open("GA_Subarray_Selection/Cfg_Input_Files/"+file_0,"wb") as fw:
            fw.write(file_name)
    print "### Done"
