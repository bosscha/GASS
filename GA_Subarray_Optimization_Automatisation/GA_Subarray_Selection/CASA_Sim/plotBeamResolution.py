...
for i in range(0,len(minor0)):
  ...
  res9.append(math.sqrt(minor9[i]*major9[i]))
  res10.append(math.sqrt(minor10[i]*major10[i]))
...
ax.semilogy(dec8,res8,'b-')
ax.semilogy(dec9,res9,'b-')
ax.semilogy(dec10,res10,'r-')
...
pl.savefig("beamResolutionDeclination-Cy5.png")
pl.show()
